 ...
 */
export const BUCKET_NAME_PATTERN = new RegExp(
  `^(${ALLOWED_BUCKET_PREFIXES.join("|")})(-[a-z0-9]+)+$`,
);
 ...
 */
export const BUCKET_NAME_HELP = `Bucket names must start with one of: ${ALLOWED_BUCKET_PREFIXES.join(
  ", ",
)}, then use lowercase letters, numbers, and dashes (for example: "marketing-q3-launch" or "brand-logos").`;
